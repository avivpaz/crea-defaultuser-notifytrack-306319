...
interface CarrierServicePageProps {
  ...
  price: string;
  imageUrl?: string;
  carrier: string; // Add carrier prop
...
const CarrierServicePage: React.FC<CarrierServicePageProps> = ({
  ...
  carrier = 'USPS', // Default to USPS for backward compatibility
  relatedServices = []
}) => {
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="space-y-8">
            ...
            <div className="bg-primary rounded-xl shadow-sm p-6 text-white">
              ...
              <p className="mb-6 text-white/90">Enter your tracking number to get real-time updates on your {carrier} shipment.</p>
              <Link 
                href={`/?carrier=${carrier.toLowerCase()}`}
